...
<Dialog>
  <DialogTrigger asChild>
    <Button variant="outline" className=" bg-black text-white ">add Comany</Button>
  </DialogTrigger>
  <DialogContent className="sm:max-w-[425px]">
    <DialogHeader>
      <DialogTitle>Add company</DialogTitle>
      <DialogDescription>
        add new company here. Click save when you're done.
      </DialogDescription>
    </DialogHeader>
    <div className="grid gap-4 py-4">
      ...
      <div className="grid grid-cols-4 items-center gap-4">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="name" value={inputCategorie} onChange={handleInputChange2} className="col-span-3" />
              </div>
